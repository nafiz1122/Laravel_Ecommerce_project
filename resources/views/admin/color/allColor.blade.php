  ...
  <div class="modal fade" id="exampleModalCenter" tabindex="1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="{{ url('/storeColor') }}" method="POST" >
              @csrf
    ...
    <div class="row">
        ...
        <div class="col-md-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <div class="card-head">
                        <button class="btn btn-success btn-sm pull-right m-2"  data-toggle="modal" data-target="#exampleModalCenter" > <b>+</b> Add Color</button>
                        <h3>All Color</h3>
